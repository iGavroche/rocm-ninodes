#!/usr/bin/env python3
"""
Create a simple baseline VAE decode to compare against
"""
import torch
...
class SimpleVAEDecode:
    """
    Simple VAE decode without any optimizations - true baseline
    """
    ...
    def decode(self, vae, samples, tile_size=768, overlap=96, use_rocm_optimizations=True, 
        ...
        """
        Simple VAE decode - minimal overhead baseline
        """
        try:
    ...
    def _decode_tiled_simple(self, vae, samples, tile_size, overlap):
        """Simple tiled decode - minimal overhead"""
        samples_processed = samples["samples"]
...
NODE_CLASS_MAPPINGS = {
    "SimpleVAEDecode": SimpleVAEDecode
}

NODE_DISPLAY_NAME_MAPPINGS = {
    "SimpleVAEDecode": "Simple VAE Decode (Baseline)"
}
